...
def do_runtime_experiments():
    ...
    hdfs_path = "sample_data.json"  # TODO: Remove temp path
    ...
    for max_cores in max_core_values:
        run_pipeline(master_address, app_name, max_cores, hdfs_path, subs_to_incl, comment_threshold)


def run_pipeline(master_address, app_name, max_cores, hdfs_path, subs_to_incl, comment_threshold):
    ...
    # Save output and computation time in csv files
